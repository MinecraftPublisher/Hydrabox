...
let Hydra = function() {
  ...
  Hydrabox.write('<style> hydra { background-color: grey; border-radius: 10px; position: fixed; bottom: -1px; left: -1px; padding-left: 10px; padding-bottom: 10px; min-width: 200px; min-height: 60px; style: display: none; } </style>')
